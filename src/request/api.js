...
export const getCampStatisInfo = p => get(CONFIG.STATISTIC.CAMP_STATISTICS_INFO, p) // 获取项目统计详情
export const exporCampStatisInfo = p => post(CONFIG.STATISTIC.EXPORT_CAMP_STATISTICS_INFO, p) // 导出项目统计详情
